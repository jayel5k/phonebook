<?php
	...
	$q2="SELECT a.descrip,a.uprice,a.unit,b.qnty FROM products AS a, trans_dtl AS b WHERE tcode='$_GET[tid]'
		AND a.pcode=b.pcode ";
...
<div align="center"><br>
  ...
  <form name="form1" method="POST" action="admin_okpaid.php">
      ...
      <?php
		...
		while($row=@mysql_fetch_array($result2)) {
    		...
    		print("<tr> 
      			...
      			<td align=\"right\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">$row[qnty]</font></td>
    ...
    <br>
    OR Number: 
    <input name="orno" type="text" id="orno">
    <br>
    <br>

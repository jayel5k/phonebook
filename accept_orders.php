<?php
	...
	$q2="SELECT a.status,a.tcode,DATE_FORMAT(a.orderdate,'%M %e, %Y') AS deyt,b.fname,b.lname FROM trans AS a,customer AS b
		 WHERE status='P' and a.custno=b.custno ORDER by orderdate DESC ";
      ...
      <?php
		while($row=@mysql_fetch_array($result2)) {
    		...
    		print("<tr align=\"center\"> 
      			<td><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><a href=\"admin_dtltrans.php?tid=$row[tcode]&dt=$row[deyt]\">$row[tcode]</a></font></td>
